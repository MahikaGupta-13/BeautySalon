...
namespace BeautySalon
{
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("insert into userreg(name, dob, contact, email, state, city, pincode, address, userid, password) values(@Name, @dob, @contact, @email, @state, @city, @pincode, @address, @userid, @password)", sc);
