<%@ Page Title="" Language="C#" MasterPageFile="~/adminedit.Master" AutoEventWireup="true" CodeBehind="addstaff.aspx.cs" Inherits="BeautySalon.addstaff" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                           <img width="250px" src="folder/admin-img1.jpg"/>
                        </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <asp:Button class="btn btn-info btn-lg" ID="Button3" runat="server" Text="ADD" OnClick="Button3_Click" />
                                </div>
